      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <label className="flex items-center gap-2 cursor-pointer bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
          <input
            ...
            className="w-4 h-4 text-[#004B39] rounded border-slate-300"
          />
          <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            className="w-full text-sm p-3 border border-slate-200 rounded-lg outline-none focus:border-[#004B39]"
          />
