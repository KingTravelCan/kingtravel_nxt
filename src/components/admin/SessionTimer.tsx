...
export default function SessionTimer({ loginTime }: SessionTimerProps) {
  ...
  return (
    <>
      ...
      <div
        className={`flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-extrabold transition-all shadow-xs border cursor-help ${
          isWarningState
      ...
      >
        ...
        <span>
          <span className="text-slate-400 font-medium hidden sm:inline">Session: </span>
          <span className="font-mono font-bold tracking-tight text-slate-900">{formattedTime}</span>
        </span>
      </div>
