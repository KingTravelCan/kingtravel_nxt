    ...
    <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-5">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-500 to-[#004B39] flex items-center justify-center text-white shadow-md shadow-emerald-500/20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-[#F8FAFC] rounded-2xl p-5 border border-slate-200 space-y-3">
          <div className="text-xs font-extrabold text-slate-800 flex items-center gap-1.5">
            <TrendingUp className="w-3.5 h-3.5 text-emerald-600" /> CORE CATEGORY BREAKDOWN
          </div>
        ...
        <div className="bg-[#F8FAFC] rounded-2xl p-5 border border-slate-200 space-y-3">
          <div className="text-xs font-extrabold text-slate-800 flex items-center gap-1.5">
            <Sparkles className="w-3.5 h-3.5 text-[#DB9E30]" /> AI ENGINE READINESS
          </div>
          ...
          <div className="space-y-2">
            <div>
              ...
              <div className="w-full bg-slate-200 rounded-full h-1.5 overflow-hidden">
                <div className="bg-[#004B39] h-full rounded-full w-[90%]" />
              </div>
            </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-xs font-extrabold text-slate-900 m-0 flex items-center gap-1.5">
              <BarChart2 className="w-4 h-4 text-[#004B39]" /> Monthly SEO Indexability &amp; Health Performance
            </h3>
          ...
          {pagesNeedingAttention.map((p) => (
            ...
            >
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-emerald-50 text-[#004B39] border border-emerald-300 text-xs font-extrabold hover:bg-[#004B39] hover:text-white transition-all cursor-pointer shadow-xs shrink-0 self-start sm:self-center"
              >
