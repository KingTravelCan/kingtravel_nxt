            ...
            return (
              <Link
                ...
                className={`flex items-center gap-2.5 px-3 py-2.5 rounded-md text-xs transition-all ${isActive
                  ? 'text-[#004B39] font-bold bg-primary text-white shadow-md border-l-4 border-primary pl-2.5'
                  : 'text-slate-500 font-medium group hover:bg-primary/5 hover:text-ink hover:shadow-sm'
                  }`}
              >
                <span className={`shrink-0 ${isActive ? 'text-white' : 'text-slate-500 group-hover:text-ink'}`}>
                  {item.icon}
                </span>
                {item.label}
              </Link>
        ...
        <header className="bg-white border-b border-slate-200/80 px-6 py-3 flex items-center justify-between gap-4 shrink-0 shadow-xs z-30 relative">
          ...
          <div className="flex items-center gap-3 ml-auto">
            ...
            <Link
              href="/"
              target="_blank"
              className="inline-flex items-center gap-1.5 text-xs font-extrabold text-[#004B39] bg-white border border-slate-300 hover:border-[#004B39] hover:bg-[#004B39] hover:text-white rounded-full px-4 py-1.5 transition-all shadow-xs group"
            >
                ...
                <div className="absolute right-0 mt-2 w-72 bg-white rounded-2xl shadow-xl border border-slate-200 p-4 z-50 animate-in fade-in slide-in-from-top-2 duration-150">
                  <div className="flex items-center justify-between border-b border-slate-100 pb-2.5 mb-3">
                    <span className="text-xs font-extrabold text-slate-800 flex items-center gap-1.5">
                      <Bell className="w-3.5 h-3.5 text-[#004B39]" /> Notifications
                    </span>
                  ...
                  <div className="space-y-2.5">
                    <div className="flex items-start gap-2.5 p-2 rounded-xl bg-slate-50 border border-slate-100">
                      ...
                      <div>
                        <div className="text-[11px] font-bold text-slate-800">Hostinger Database & FTP Active</div>
                        <div className="text-[10px] text-slate-500">Live sync operational</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="relative" ref={profileRef}>
              ...
              >
                <div className="relative shrink-0">
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#004B39] to-[#DB9E30] flex items-center justify-center font-extrabold text-xs text-white shadow-xs">
                    {userInitial}
                  </div>
              ...
              {profileOpen && (
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-150">
                  {/* Header Banner */}
                  <div className="bg-gradient-to-r from-[#004B39] to-[#00382B] p-4 text-white">
                  ...
                  <div className="p-2 space-y-1">
                    <Link
                      ...
                      className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs font-semibold text-slate-700 hover:text-[#004B39] hover:bg-emerald-50 transition-colors no-underline"
                    >
                      <Settings className="w-4 h-4 text-[#004B39]" />
