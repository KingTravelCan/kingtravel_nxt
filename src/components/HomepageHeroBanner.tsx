            ...
            <form noValidate className="flex flex-col gap-4" onSubmit={handleQuoteSubmit}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full bg-[#DB9E30] text-black font-extrabold py-3.5 px-6 rounded-xl shadow-md hover:bg-primary hover:text-white active:scale-[0.99] transition-all duration-300 tracking-wider uppercase text-sm flex items-center justify-center cursor-pointer"
                  >
                    <span>SUBMIT</span>
                  </button>
                </div>
