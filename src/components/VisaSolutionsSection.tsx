          ...
          {items.map((card: any, cIdx: number) => (
            ...
            >
              ...
              <div className="card-content p-6 flex-1 flex flex-col justify-between">
                ...
                <Link
                  href="/contact"
                  className="mt-5 inline-flex items-center justify-center bg-[#db9e30] text-black font-bold text-sm px-6 py-3 rounded-full hover:bg-[#00372a] hover:text-white transition-colors"
                >
                  Apply Now
                </Link>
              </div>
