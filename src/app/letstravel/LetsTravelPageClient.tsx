          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                name="email"
                required
                className={`w-full px-4 py-3 text-sm bg-white border border-1 border-[#d1d1d1] !text-ink rounded-md outline-none transition !placeholder:text-slate-200 autofill:bg-white autofill:[shadow:0_0_0_1000px_white_inset] autofill:[-webkit-text-fill-color:#1e293b] ${
                  error
