    ...
    <main>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            <div className="relative justify-self-center lg:justify-self-end">
              <div className="rounded-[40px] overflow-hidden shadow-2xl relative aspect-[4/3] w-[90vw] max-w-[550px]">
                <img src="uploads\sections\hajj_1.jpg" alt="Kaaba" className="w-full h-full object-cover" />
              </div>
      ...
      <section className="py-20 bg-[#fbfcf9]">
        <div className="max-w-[1400px] mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div>
              <h3 className="text-[#DB9E30] font-black uppercase tracking-widest text-xs mb-3">LUXURY HAJJ PACKAGES</h3>
              <h2 className="text-4xl md:text-5xl font-serif text-[#004B39] leading-tight">Hajj Packages 2027</h2>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-2 lg:order-1">
              <div className="rounded-[40px] overflow-hidden shadow-[0_20px_50px_rgb(0,0,0,0.1)] w-full aspect-square max-w-[600px] mx-auto lg:mx-0">
                <img
                  src="uploads\sections\hajj_1.jpg"
            ...
            <div className="order-1 lg:order-2">
              <h3 className="text-[#DB9E30] font-black uppercase tracking-[0.2em] text-sm mb-4">WHAT WE PROVIDE</h3>
              <h2 className="text-4xl md:text-5xl font-serif text-[#004B39] leading-[1.15] mb-12">
                Lowest fares, exclusive<br />travel deals, real trust
              </h2>

              <div className="flex flex-col">
                {/* Item 01 */}
                <div className="flex gap-6 items-start py-6 border-b border-gray-200">
                  <div className="w-12 h-12 shrink-0 rounded-2xl bg-[#faeed8] flex items-center justify-center text-[#DB9E30] font-serif text-lg">
                    01
                  </div>
                  <div>
                    <h4 className="text-[#1a2b25] font-serif text-lg mb-2">Lowest Fares</h4>
                    <p className="text-gray-500 text-sm leading-relaxed">
                      We offer the lowest rates on the market, sourced across every route into Jeddah.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-6 items-start py-6 border-b border-gray-200">
                  ...
                  <div>
                    <h4 className="text-[#1a2b25] font-serif text-lg mb-2">Special Deals</h4>
                    <p className="text-gray-500 text-sm leading-relaxed">
                      Fixed-price Umrah packages with hotels, meals and transport included.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-6 items-start py-6 border-b border-gray-200">
                  ...
                  <div>
                    <h4 className="text-[#1a2b25] font-serif text-lg mb-2">Trusted & Certified</h4>
                    <p className="text-gray-500 text-sm leading-relaxed">
                      A fully accredited travel agency you can rely on, licensed across Canada.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-6 items-start py-6 border-b border-gray-200">
                  ...
                  <div>
                    <h4 className="text-[#1a2b25] font-serif text-lg mb-2">Pilgrimage Services</h4>
                    <p className="text-gray-500 text-sm leading-relaxed">
                      Visa processing, group support — the full spiritual journey, arranged.
                    </p>
                  </div>
                </div>
              </div>
