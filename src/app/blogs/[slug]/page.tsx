        ...
        <div className="section-inner">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-10 items-start">
            ...
            <article>
              ...
              {/* Article body */}
              <div
                className="prose prose-slate max-w-none bg-white rounded-3xl shadow-sm p-8 md:p-10 overflow-hidden
                  [&_h1]:text-2xl [&_h1]:font-bold [&_h1]:text-slate-900 [&_h1]:mt-8 [&_h1]:mb-4
                  [&_h2]:text-xl [&_h2]:font-bold [&_h2]:text-slate-900 [&_h2]:mt-8 [&_h2]:mb-4 [&_h2]:border-b [&_h2]:border-slate-100 [&_h2]:pb-2
                  [&_h3]:text-lg [&_h3]:font-bold [&_h3]:text-[#004B39] [&_h3]:mt-6 [&_h3]:mb-3
                  [&_p]:text-[15px] [&_p]:text-slate-700 [&_p]:leading-relaxed [&_p]:mb-4
                  [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:mb-4 [&_ul>li]:text-[15px] [&_ul>li]:text-slate-700 [&_ul>li]:mb-1.5
                  [&_ol]:list-decimal [&_ol]:pl-6 [&_ol]:mb-4 [&_ol>li]:text-[15px] [&_ol>li]:text-slate-700 [&_ol>li]:mb-1.5
