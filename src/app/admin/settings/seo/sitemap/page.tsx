    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex gap-6 mb-6 border-b border-slate-200">
        <button
          ...
          className={`pb-3 px-2 border-b-2 font-medium ${activeTab === 'overview' ? 'border-[#004B39] text-[#004B39]' : 'border-transparent text-slate-500 hover:text-slate-700'}`}
        >
          <div className="flex items-center gap-2"><FileText size={16}/> Overview</div>
        </button>
        <button
          onClick={() => setActiveTab('config')}
          className={`pb-3 px-2 border-b-2 font-medium ${activeTab === 'config' ? 'border-[#004B39] text-[#004B39]' : 'border-transparent text-slate-500 hover:text-slate-700'}`}
        >
          <div className="flex items-center gap-2"><Settings size={16}/> Configuration</div>
        </button>
        <button
          onClick={() => setActiveTab('logs')}
          className={`pb-3 px-2 border-b-2 font-medium ${activeTab === 'logs' ? 'border-[#004B39] text-[#004B39]' : 'border-transparent text-slate-500 hover:text-slate-700'}`}
        >
          ...
          <div className="p-6">
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                ...
                disabled={saving}
                className="flex items-center gap-2 px-4 py-2 bg-[#004B39] text-white rounded-lg hover:bg-opacity-90 disabled:opacity-50"
              >
                <Save size={16} />
                      ...
                      <div>
                        <label className="flex items-center gap-2 cursor-pointer">
                          <input
                            ...
                            className="w-4 h-4 text-[#004B39] rounded border-slate-300 focus:ring-[#004B39]"
                          />
