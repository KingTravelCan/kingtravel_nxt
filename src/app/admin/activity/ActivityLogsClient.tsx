      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-3">
            ...
            <span className="bg-[#004B39] text-white text-xs font-extrabold px-2.5 py-0.5 rounded-full shadow-xs">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={`inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-extrabold transition-all shadow-xs cursor-pointer active:scale-95 ${
              justRefreshed
          ...
          >
            {isRefreshing ? (
              ...
              <>
                <RefreshCw className="w-3.5 h-3.5 text-[#004B39]" />
                <span>Refresh</span>
              </>
            )}
          </button>
      ...
      <div className="bg-white border border-slate-200/80 rounded-2xl p-4 flex items-center gap-3 flex-wrap shadow-xs">
        ...
        <span
          ...
          className={`inline-flex items-center gap-1.5 text-[11px] font-bold px-3 py-1 rounded-full cursor-pointer transition-all border ${selectedType === 'all'
            ? 'bg-[#004B39] text-white border-[#004B39] shadow-xs'
        ...
        {Object.entries(TYPE_CONFIG).map(([key, cfg]) => {
          ...
          return (
            <button
              ...
              className={`inline-flex items-center gap-1.5 text-[11px] font-bold px-3 py-1 rounded-full cursor-pointer transition-all border ${isSelected ? 'ring-2 ring-offset-1 ring-[#004B39] shadow-xs' : 'hover:scale-105'
                }`}
            >
              <span
                style={{
