      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-2 border-b border-slate-100">
        {[
          ...
          <button
            ...
            className={`px-4 py-2 rounded-full text-xs font-extrabold transition-all border cursor-pointer whitespace-nowrap ${
              formTypeTab === tab.key
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white p-4 rounded-3xl border border-slate-100 shadow-2xs">
        <div className="relative flex-1 w-full max-w-md">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-xl text-xs outline-none focus:border-[#004B39]"
          />
        </div>
                ...
                filtered.map((item) => {
                  ...
                  return (
                    <tr key={item.id} className="hover:bg-slate-50/60 transition-colors">
                      ...
                      <td className="py-3.5 px-4 font-extrabold text-[#004B39]">
                      ...
                      <td className="py-3.5 px-4">
                        <select
                          ...
                          className={`px-3 py-1 rounded-full text-[10px] font-extrabold outline-none cursor-pointer border ${
                            item.status === 'new'
