                            ...
                            {(sec.type === 'Umrah Packages' || sec.type === 'Hajj Packages' || sec.type === 'Umrah Packages Grid' || sec.type === 'Packages Grid' || sec.type === 'Upcoming Umrah Packages' || sec.type === 'Upcoming Hajj Packages' || sec.type === 'Sold Out Packages') && (
                              <div className="bg-white border border-slate-200 rounded-xl p-3.5 flex flex-col gap-3 mt-1">
                                ...
                                <div className="flex flex-col gap-2">
                                  ...
                                  <select
                                    className="w-full px-3.5 py-2 border border-slate-200 rounded-xl text-xs outline-none focus:border-[#004B39] bg-slate-50"
                                    onChange={(e) => {
                                  ...
                                  {(sec.data?.packageIds || []).map((id: number, idx: number) => {
                                    ...
                                    return (
                                      <div
                                        ...
                                        className={`flex items-center gap-3 p-3 bg-white border rounded-lg cursor-grab active:cursor-grabbing transition-colors ${draggedPackageIdx === idx ? 'border-[#004B39] shadow-md z-10' : 'border-slate-200 hover:border-slate-300 shadow-2xs'}`}
                                      >
                                        ...
                                        <div className="flex-1 overflow-hidden">
                                          ...
                                          <div className="text-[10px] text-slate-500 truncate">
                                            CAD ${pkg.startingPrice} • {pkg.month}
                                          </div>
                                        </div>
                                        <button
                                          onClick={(e) => {
