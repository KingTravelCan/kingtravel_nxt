                              ...
                              <div className="bg-white border border-slate-200 rounded-xl p-3.5 flex flex-col gap-3 mt-1">
                                ...
                                <div className="p-3 bg-emerald-50 rounded-xl border border-emerald-200 flex items-center justify-between">
                                  ...
                                  <Link
                                    href="/admin/blogs"
                                    target="_blank"
                                    className="bg-[#004B39] text-white px-3.5 py-1.5 rounded-lg text-xs font-bold no-underline hover:bg-[#00382B] transition-colors"
                                  >
                                    Open Blog Manager ⚙️
                                  </Link>
                                </div>
                              ...
                              <div className="bg-white border border-slate-200 rounded-xl p-3.5 flex flex-col gap-3 mt-1">
                                <div className="flex justify-between items-center pb-2 border-b border-slate-200">
                                  ...
                                  <button
                                    onClick={() => {
                                      const defaultItems = [
                                        { title: "5 Star Umrah Package", month: "AUGUST 2026", price: "2,895", heroImage: "https://antiquewhite-stinkbug-399384.hostingersite.com/wp-content/uploads/2026/05/Umrah_packages_202605092201.jpeg", starRating: 5, isActiveCard: false, buttonText: "BOOK NOW", buttonUrl: "#contact", includes: ["Return Flights from Toronto", "Luxury Ground Transportation", "Free Ihram Kit", "Registration & Visa Assistance", "Imam Lead Guide & Seminar", "5 Star Hotels Makkah & Madinah"] },
                                        { title: "5 Star Umrah Package", month: "SEPTEMBER 2026", price: "2,695", heroImage: "https://antiquewhite-stinkbug-399384.hostingersite.com/wp-content/uploads/2026/05/Umrah_packages_202605092201.jpeg", starRating: 5, isActiveCard: true, buttonText: "BOOK NOW", buttonUrl: "#contact", includes: ["Return Flights from Toronto", "Luxury Ground Transportation", "Free Ihram Kit", "Registration & Visa Assistance", "Imam Lead Guide & Seminar", "5 Star Hotels Makkah & Madinah"] },
                                        { title: "5 Star Umrah Package", month: "OCTOBER 2026", price: "2,795", heroImage: "https://antiquewhite-stinkbug-399384.hostingersite.com/wp-content/uploads/2026/05/Umrah_packages_202605092201.jpeg", starRating: 5, isActiveCard: false, buttonText: "BOOK NOW", buttonUrl: "#contact", includes: ["Return Flights from Toronto", "Luxury Ground Transportation", "Free Ihram Kit", "Registration & Visa Assistance", "Imam Lead Guide & Seminar", "5 Star Hotels Makkah & Madinah"] },
                                        { title: "5 Star Umrah Package", month: "NOVEMBER 2026", price: "2,795", heroImage: "https://antiquewhite-stinkbug-399384.hostingersite.com/wp-content/uploads/2026/05/Umrah_packages_202605092201.jpeg", starRating: 5, isActiveCard: false, buttonText: "BOOK NOW", buttonUrl: "#contact", includes: ["Return Flights from Toronto", "Luxury Ground Transportation", "Free Ihram Kit", "Registration & Visa Assistance", "Imam Lead Guide & Seminar", "5 Star Hotels Makkah & Madinah"] }
                                      ];
                                      const currentPkgs = Array.isArray(sec.data?.items) && sec.data.items.length > 0 ? [...sec.data.items] : defaultItems;
                                      currentPkgs.push({
                                        title: "New Umrah Package",
                                        month: "DECEMBER 2026",
                                        price: "2,995",
                                        ...
                                        buttonText: "BOOK NOW",
                                        buttonUrl: "#contact",
                                        includes: ["Return Flights from Toronto", "5 Star Hotel Makkah", "Visa Assistance"]
                                      });
                                  ...
                                  >
                                    + Add Umrah Package Card
                                  </button>
                                </div>
                                {(Array.isArray(sec.data?.items) && sec.data.items.length > 0 ? sec.data.items : [
                                  { title: "5 Star Umrah Package", month: "AUGUST 2026", price: "2,895", heroImage: "https://antiquewhite-stinkbug-399384.hostingersite.com/wp-content/uploads/2026/05/Umrah_packages_202605092201.jpeg", starRating: 5, isActiveCard: false, buttonText: "BOOK NOW", buttonUrl: "#contact", includes: ["Return Flights from Toronto", "Luxury Ground Transportation", "Free Ihram Kit", "Registration & Visa Assistance", "Imam Lead Guide & Seminar", "5 Star Hotels Makkah & Madinah"] },
                                  { title: "5 Star Umrah Package", month: "SEPTEMBER 2026", price: "2,695", heroImage: "https://antiquewhite-stinkbug-399384.hostingersite.com/wp-content/uploads/2026/05/Umrah_packages_202605092201.jpeg", starRating: 5, isActiveCard: true, buttonText: "BOOK NOW", buttonUrl: "#contact", includes: ["Return Flights from Toronto", "Luxury Ground Transportation", "Free Ihram Kit", "Registration & Visa Assistance", "Imam Lead Guide & Seminar", "5 Star Hotels Makkah & Madinah"] },
                                  { title: "5 Star Umrah Package", month: "OCTOBER 2026", price: "2,795", heroImage: "https://antiquewhite-stinkbug-399384.hostingersite.com/wp-content/uploads/2026/05/Umrah_packages_202605092201.jpeg", starRating: 5, isActiveCard: false, buttonText: "BOOK NOW", buttonUrl: "#contact", includes: ["Return Flights from Toronto", "Luxury Ground Transportation", "Free Ihram Kit", "Registration & Visa Assistance", "Imam Lead Guide & Seminar", "5 Star Hotels Makkah & Madinah"] },
                                  { title: "5 Star Umrah Package", month: "NOVEMBER 2026", price: "2,795", heroImage: "https://antiquewhite-stinkbug-399384.hostingersite.com/wp-content/uploads/2026/05/Umrah_packages_202605092201.jpeg", starRating: 5, isActiveCard: false, buttonText: "BOOK NOW", buttonUrl: "#contact", includes: ["Return Flights from Toronto", "Luxury Ground Transportation", "Free Ihram Kit", "Registration & Visa Assistance", "Imam Lead Guide & Seminar", "5 Star Hotels Makkah & Madinah"] }
                                  ...
                                  const getActiveItems = () => {
                                    ...
                                    return Array.isArray(sec.data?.items) && sec.data.items.length > 0 ? [...sec.data.items] : base;
                                  };
                                  ...
                                  return (
                                    <div key={pIdx} className="bg-slate-50 border border-slate-300 rounded-lg p-3 flex flex-col gap-2.5">
                                      ...
                                      <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
                                        ...
                                        <div>
                                          <label className="block text-[10px] font-bold text-slate-500 mb-0.5">STAR RATING (1-5)</label>
                                          <input
                                            type="number"
                                            min={1}
                                            max={5}
                                            value={pkg.starRating || 5}
                                            onChange={(e) => {
                                              const pkgs = getActiveItems();
                                              pkgs[pIdx] = { ...pkgs[pIdx], starRating: parseInt(e.target.value) || 5 };
                                              updateSectionData(sec.id, 'items', pkgs);
                                            }}
                                            className="w-full px-2.5 py-1.5 rounded-md border border-slate-300 text-xs font-bold text-slate-900 bg-white"
                                          />
                                      ...
                                      <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-3 items-center pt-1 border-t border-slate-200">
                                        <div>
                                          <label className="block text-[10px] font-bold text-slate-500 mb-1">
                                            🖼 CARD TOP HERO IMAGE (UPLOAD & PREVIEW)
                                          </label>
                                          <div className="flex items-center gap-3">
                                            {pkg.heroImage && (
                                              <div className="relative w-24 h-14 rounded-lg overflow-hidden border border-slate-300 shadow-2xs">
                                        ...
                                        <label className="flex items-center gap-2 cursor-pointer pt-2">
                                          <input
                                            type="checkbox"
                                            checked={!!pkg.isActiveCard}
                                            onChange={(e) => {
                                              const pkgs = getActiveItems();
                                              pkgs[pIdx] = { ...pkgs[pIdx], isActiveCard: e.target.checked };
                                              updateSectionData(sec.id, 'items', pkgs);
                                            }}
                                            className="w-4 h-4 accent-[#004B39] rounded cursor-pointer"
                                          />
                                          <span className="text-xs font-bold text-slate-800">Highlight Active Gold Card</span>
                                        </label>
                                      </div>
                                      ...
                                      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 pt-1">
                                        <div>
                                          ...
                                          <input
                                            type="text"
                                            value={pkg.buttonText || 'BOOK NOW'}
                                            onChange={(e) => {
                                              const pkgs = getActiveItems();
                                              pkgs[pIdx] = { ...pkgs[pIdx], buttonText: e.target.value };
                                              updateSectionData(sec.id, 'items', pkgs);
                                            }}
                                            className="w-full px-2.5 py-1.5 rounded-md border border-slate-300 text-xs font-bold text-slate-900 bg-white"
                                          />
                                        ...
                                        <div>
                                          <label className="block text-[10px] font-bold text-slate-500 mb-0.5">BUTTON LINK / TARGET URL</label>
                                          <input
                                            type="text"
                                            value={pkg.buttonUrl || '#contact'}
                                            onChange={(e) => {
                                              const pkgs = getActiveItems();
                                      ...
                                      <div>
                                        <label className="block text-[10px] font-bold text-slate-500 mb-0.5">INCLUDED FEATURES (One per line)</label>
                                        <textarea
                                          rows={4}
                                          ...
                                          onChange={(e) => {
                                            const lines = e.target.value.split('\n');
                                            const pkgs = getActiveItems();
                                            pkgs[pIdx] = { ...pkgs[pIdx], includes: lines };
                                            updateSectionData(sec.id, 'items', pkgs);
                                          }}
                                          className="w-full px-2.5 py-1.5 rounded-md border border-slate-300 text-xs text-slate-900 bg-white font-sans"
                                        />
                                      </div>
                                    </div>
                                  );
